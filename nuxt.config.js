  ...
  */
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:image', property: 'og:image', content: POSTCONFIG.canonicalURL + POSTCONFIG.featureImage },
      ...
      { hid: 'twitter:image', name: 'twitter:image', content: POSTCONFIG.canonicalURL + POSTCONFIG.featureImage },
      ...
      { hid: 'itemprop:image', itemprop: 'image', content: POSTCONFIG.canonicalURL + POSTCONFIG.featureImage },
